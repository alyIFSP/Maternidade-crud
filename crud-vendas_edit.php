        ...
        <div class="col">
            ...
            <section class="container-fluid mt-3">
                <div class="text-container">
                    <h3 class="texto-titulo">Editar</h3>
                    <p class="texto" >Preencha os campos para editar o serviço:</p>
                </div>
                ...
                <form action="./component/edit.php" method="post">
                  <input type="hidden" name="id" value="<?php echo $_GET['id']?>"/>
                    ...
                    <div class="form-outline mb-4">
                        ...
                        <input type="text" name="nome" value=<?php echo $nome?> id="form6Example3 inputChanger" class="form-control" style="background-color: #D9D9D9;" />
                    ...
                    <div class="row mb-4">
                        ...
                        <div class="col">
                            <div class="form-outline">
                                ...
                                <input type="number" name="valor" value="<?php echo $valor?>" id="form6Example2 inputChanger" class="form-control" style="background-color: #D9D9D9;" />
